...
description: >-
  ...
  При ЛЮБОЙ задаче — читать reference.md ПЕРВЫМ. Не сканировать проект. При изменении кода — синхронизировать SKILL.md и reference.md. После каждого изменения — commit и push. SSH: 46.173.17.188:2222 (SSH).
---
...
| Сервер | SSH `46.173.17.188` (SSH `:2222`) |
| Порт | 7000 (Gunicorn) |
