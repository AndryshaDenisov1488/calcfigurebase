...
# -*- coding: utf-8 -*-
"""
Проверка списка «Фамилия Имя» (1820022026lakernik) по базе спортсменов (Athlete).

Список: scripts/1820022026lakernik.txt
Совпадение: по 2 словам (фамилия + имя) с полным ФИО в БД.

Использование (из корня проекта):
  python scripts/1820022026lakernik.py
"""
...
LIST_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), '1820022026lakernik.txt')
...
def main():
    ...
    print("=" * 70)
    print("ПРОВЕРКА СПИСКА 1820022026lakernik ПО БАЗЕ (ФАМИЛИЯ + ИМЯ)")
    print("=" * 70)
