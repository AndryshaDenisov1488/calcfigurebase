...
def run_migrations_online():
    ...
    # Callback to skip FK from database if referenced table doesn't exist
    # This fixes the issue when comparing empty DB with metadata
    def include_object(object, name, type_, reflected, compare_to):
        if type_ == 'foreign_key_constraint' and reflected:
            # Skip FK from DB if we're comparing with metadata
            return False
        return True
